...
## Requires ["Cortana Server Browser"](https://github.com/faithvoid/script.cortanaserverbrowser) && ["Cortana Chat"](https://github.com/faithvoid/plugin.programs.cortanachat) to function correctly!
