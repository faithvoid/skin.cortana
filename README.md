...
## Requires ["Cortana Server Browser"](https://github.com/faithvoid/script.cortanaserverbrowser) && ["Cortana Chat"](https://github.com/faithvoid/script.cortanachat) to function correctly!
